...
class CapIT(ctk.CTk):
    ...
    def setup_ui(self):
        ...
        self.home_btn = ctk.CTkButton(self.sidebar, text="Home", height=45, corner_radius=22,
                                     command=lambda: self.show_frame("home"))
        self.home_btn.pack(padx=25, pady=10, fill="x")

        self.settings_btn = ctk.CTkButton(self.sidebar, text="Settings", height=45, corner_radius=22,
                                         command=lambda: self.show_frame("settings"))
        self.settings_btn.pack(padx=25, pady=10, fill="x")

        self.credits_btn = ctk.CTkButton(self.sidebar, text="Credits", height=45, corner_radius=22,
                                        command=lambda: self.show_frame("credits"))
    ...
    def build_home(self):
        header_text = "CapIT: AI-Powered Captioning Tool\n"
        sub_text = "Transcribe or translate your media files into .SRT subtitles using AI."
        
        header = ctk.CTkLabel(self.home_frame, text=header_text, text_color=("gray10", "white"), 
                              font=ctk.CTkFont(size=24, weight="bold"), justify="left")
        header.pack(pady=(40, 5), padx=40, anchor="w")
        
        desc = ctk.CTkLabel(self.home_frame, text=sub_text, text_color=("gray30", "gray70"), 
        ...
        ctk.CTkOptionMenu(m_col, values=["tiny", "base", "small", "medium"], variable=self.model_choice, height=40, corner_radius=20, fg_color=self.accent_blue).pack()
    ...
    def build_settings(self):
        header = ctk.CTkLabel(self.settings_frame, text="Settings", text_color=("gray10", "white"), font=ctk.CTkFont(size=24, weight="bold"))
        header.pack(pady=(40, 20), padx=40, anchor="w")

        s_card = ctk.CTkFrame(self.settings_frame, corner_radius=25, border_width=1)
        s_card.pack(padx=40, pady=10, fill="x")
        ...
        btn_row = ctk.CTkFrame(self.settings_frame, fg_color="transparent")
        btn_row.pack(pady=30, padx=40, fill="x")
    ...
    def build_credits(self):
        header = ctk.CTkLabel(self.credits_frame, text="Credits & Developer Info", text_color=("gray10", "white"), font=ctk.CTkFont(size=24, weight="bold"))
        header.pack(pady=(40, 20), padx=40, anchor="w")
        ...
        github_link = "https://github.com/ChaitanyaKumarS2403"
        gh_btn = ctk.CTkButton(c_card, text="View GitHub Profile", fg_color="transparent", border_width=1, 
                               text_color=("gray10", "gray90"), hover_color=self.accent_blue,
